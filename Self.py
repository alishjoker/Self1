...
owner =["u8b97ff6d6190da6f27485d9513a353e9"]
admin = ["u8b97ff6d6190da6f27485d9513a353e9"]
wait = {
    'contact':False,
    'autoJoin':True,
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u8b97ff6d6190da6f27485d9513a353e9'}
                    cl.sendMessage(msg)
    ...
    for zx in range(0,200):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Alish Joker⭐⭐👈\n\n™By ✰૦ⓐⓛⓘⓢⓗც૦੮✰")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by Alish Joker ^\nBokkls\nOwner Kami :\nalish")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✰૦Ո૯ alishjokerbot✰")
                    print "Like"
                except:
                    pass
            else:
